...
export default function EditTheme() {
  ...
  const fetchTheme = async () => {
    try {
      ...
      setFormData({
        ...
        primary_color: theme.primary_color || '#D97706',
        secondary_color: theme.secondary_color || '#92400E',
        ...
        button_radius: theme.button_radius || '6px',
        container_max_width: theme.container_max_width || '1280px',
        spacing_scale: theme.spacing_scale || '1',
        card_style: theme.card_style || 'elevated',
        card_radius: theme.card_radius || '8px',
        card_shadow: theme.card_shadow || '0 1px 3px 0 rgb(0 0 0 / 0.1)',
        card_hover_effect: theme.card_hover_effect || 'lift',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await themeAPI.update(id, formData);
  ...
  return (
    <>
      <Head>
        <title>Edit Theme - ENOT Admin</title>
      </Head>
