...
export default function CreateHero() {
  ...
  const [formData, setFormData] = useState({
    title: 'E°',
    subtitle: 'PERFECTION TO THE HIGHEST DEGREE',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Failed to create hero section');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <Head>
        <title>Create Hero Section - ENOT Admin</title>
      </Head>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Create Hero Section</h1>
          <p className="mt-1 text-sm text-gray-500">
            Create a new homepage hero section with custom content and styling
          </p>
        </div>
