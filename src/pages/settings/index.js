...
export default function Settings() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      const settingsData =
        response.data.data?.settings || response.data.settings || response.data;
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <p className="mt-2 text-sm text-yellow-700">
              Changing security settings affects all admin users. Please proceed
              with caution.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleDirectChange("passwordExpiry", parseInt(e.target.value))
            }
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
          />
        </div>
    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleDirectChange("taxRate", parseFloat(e.target.value))
              }
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleDirectChange("shippingRate", parseFloat(e.target.value))
              }
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            />
          </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            handleDirectChange("returnWindow", parseInt(e.target.value))
          }
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <label className="inline-flex items-center">
            <input
              ...
              onChange={(e) =>
                handleDirectChange("trackingEnabled", e.target.checked)
              }
              className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
            />
          </label>
      ...
      <div className="grid grid-cols-1 gap-6">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleDirectChange("googleAnalytics", e.target.value)
            }
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleDirectChange("facebookPixel", e.target.value)
            }
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <p className="mt-2 text-sm text-blue-700">
              Analytics tracking helps improve your store&apos;s performance.
              All data is processed according to privacy regulations.
            </p>
          </div>
        </div>
      </div>
